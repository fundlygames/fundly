  ...
  const DICT = {
    en: {
      ...
      gs: {
        ...
        trustHeading: "Built to be trusted, not just believed.",
        trust1Title: "Payments handled by Whop", trust1Desc: "Checkout runs on Whop's payment infrastructure — cards, Apple Pay, Google Pay and crypto — we never see or store your card details.",
        trust2Title: "Fair reset, not a trap", trust2Desc: "Fail an evaluation and you don't lose everything — restart the same package for just 40% of the price, as many times as you want.",
        trust3Title: "A real, registered company", trust3Desc: "Fundly is operated by Grindit LLC, registered in Sharjah Media City, UAE (Reg. 2541536) — not an anonymous storefront.",
      },
      co: {
    ...
    cs: {
      ...
      gs: {
        ...
        trustHeading: "Postavené na důvěře, ne jen na slibech.",
        trust1Title: "Platby zajišťuje Whop", trust1Desc: "Checkout běží na platební infrastruktuře Whop — karty, Apple Pay, Google Pay i krypto — údaje o kartě nikdy nevidíme ani neukládáme.",
        trust2Title: "Fair reset, žádná past", trust2Desc: "Když hodnocení nezvládnete, nepřicházíte o vše — stejný balíček si můžete restartovat jen za 40 % ceny, tolikrát, kolikrát chcete.",
        trust3Title: "Skutečná, registrovaná firma", trust3Desc: "Fundly provozuje společnost Grindit LLC, registrovaná v Sharjah Media City, SAE (Reg. 2541536) — ne anonymní e-shop.",
      },
      co: {
    ...
    es: {
      ...
      gs: {
        ...
        trustHeading: "Construido para generar confianza, no solo promesas.",
        trust1Title: "Pagos gestionados por Whop", trust1Desc: "El checkout funciona sobre la infraestructura de pago de Whop — tarjetas, Apple Pay, Google Pay y cripto — nunca vemos ni almacenamos los datos de tu tarjeta.",
        trust2Title: "Reinicio justo, no una trampa", trust2Desc: "Si fallas una evaluación no lo pierdes todo — reinicia el mismo paquete por solo el 40% del precio, tantas veces como quieras.",
        trust3Title: "Una empresa real y registrada", trust3Desc: "Fundly es operada por Grindit LLC, registrada en Sharjah Media City, EAU (Reg. 2541536) — no una tienda anónima.",
      },
      co: {
    ...
    pl: {
      ...
      gs: {
        ...
        trustHeading: "Zbudowane na zaufaniu, nie tylko na obietnicach.",
        trust1Title: "Płatności obsługuje Whop", trust1Desc: "Checkout działa na infrastrukturze płatniczej Whop — karty, Apple Pay, Google Pay i krypto — nigdy nie widzimy ani nie przechowujemy danych Twojej karty.",
        trust2Title: "Uczciwy reset, nie pułapka", trust2Desc: "Jeśli nie zaliczysz oceny, nie tracisz wszystkiego — zresetuj ten sam pakiet za jedyne 40% ceny, tyle razy, ile chcesz.",
        trust3Title: "Prawdziwa, zarejestrowana firma", trust3Desc: "Fundly jest prowadzone przez Grindit LLC, zarejestrowaną w Sharjah Media City, ZEA (Reg. 2541536) — nie anonimowy sklep.",
      },
      co: {
    ...
    sk: {
      ...
      gs: {
        ...
        trustHeading: "Postavené na dôvere, nie len na sľuboch.",
        trust1Title: "Platby zabezpečuje Whop", trust1Desc: "Checkout beží na platobnej infraštruktúre Whop — karty, Apple Pay, Google Pay aj krypto — údaje o karte nikdy nevidíme ani neukladáme.",
        trust2Title: "Férový reset, žiadna pasca", trust2Desc: "Keď hodnotenie nezvládnete, neprichádzate o všetko — ten istý balíček si môžete reštartovať len za 40 % ceny, koľkokrát chcete.",
        trust3Title: "Skutočná, registrovaná firma", trust3Desc: "Fundly prevádzkuje spoločnosť Grindit LLC, registrovaná v Sharjah Media City, SAE (Reg. 2541536) — nie anonymný e-shop.",
      },
      co: {
    ...
    hu: {
      ...
      gs: {
        ...
        trustHeading: "Bizalomra épült, nem csak ígéretekre.",
        trust1Title: "A fizetéseket a Whop kezeli", trust1Desc: "A fizetés a Whop infrastruktúráján fut — kártyák, Apple Pay, Google Pay és kripto — a kártyaadataidat sosem látjuk és nem tároljuk.",
        trust2Title: "Igazságos reset, nem csapda", trust2Desc: "Ha nem teljesíted az értékelést, nem veszítesz el mindent — ugyanazt a csomagot újraindíthatod az ár mindössze 40%-áért, annyiszor, ahányszor akarod.",
        trust3Title: "Valódi, bejegyzett cég", trust3Desc: "A Fundly-t a Grindit LLC üzemelteti, bejegyezve Sharjah Media Cityben, EAU (Reg. 2541536) — nem egy névtelen bolt.",
      },
      co: {
