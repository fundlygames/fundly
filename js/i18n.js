  ...
  const DICT = {
    en: {
      ...
      why: {
        ...
        h4: "Fast support and rewards", p4: "Support replies within hours and approved contractor rewards are disbursed within 7 days.",
      ...
      discount: {
        title: "Get 30% off", sub: "Enter your email and we'll send you the code right away.", cta: "Send me the code", success: "Code sent — check your inbox.", off: "OFF", consent: "By requesting the code you agree to receive a few emails with offers from Fundly. Unsubscribe anytime.",
      },
      preview: {
      ...
      footer: {
        ...
        privacy: "Privacy", terms: "Terms", rules: "Rules", disclaimer: "Disclaimer", refund: "Refund", aml: "AML Policy", restrictedCountries: "Restricted Countries",
      },
      auth: {
      ...
      gs: {
        ...
        previewCtaText: "Look inside for free", previewCtaBtn: "Enter →",
        accountSize: "Account size",
        ...
        heroSub: "Fundly is an evaluation platform for sports analysts — test your risk-management strategy in a simulated environment, become a paid B2B partner, and receive real payouts within 7 days, 80% share. No wagers, no risk to your own capital — just your discipline.",
        ...
        compareSpeed: "Reward speed", compareSpeedUs: "7 days", compareSpeedThem: "days–weeks",
        ...
        mathNote: "That fixed 80/20 split plus the one-time evaluation fee is the whole business — it's the same split from your first dollar to your ten-thousandth.",
        ...
        step3Name: "Play", step3Desc: "Log in and submit your first simulated entry within minutes.",
    ...
    cs: {
      ...
      why: {
        ...
        h4: "Rychlá podpora a odměny", p4: "Podpora odpovídá do hodin a schválené dodavatelské odměny jsou vyplaceny do 7 dnů.",
      ...
      discount: {
        title: "Získej 30% slevu", sub: "Zadej svůj e-mail a hned ti pošleme kód.", cta: "Poslat mi kód", success: "Kód odeslán — zkontroluj si schránku.", off: "SLEVA", consent: "Vyžádáním kódu souhlasíš s několika e-maily s nabídkami od Fundly. Odhlásit se můžeš kdykoli.",
      },
      preview: {
      ...
      footer: {
        ...
        privacy: "Soukromí", terms: "Podmínky", rules: "Pravidla", disclaimer: "Upozornění", refund: "Vrácení peněz", aml: "AML politika", restrictedCountries: "Omezené země",
      },
      auth: {
      ...
      gs: {
        ...
        previewCtaText: "Podívej se dovnitř zdarma", previewCtaBtn: "Vstoupit →",
        accountSize: "Velikost účtu",
        ...
        heroSub: "Fundly je hodnoticí platforma pro sportovní analytiky — otestuj svou strategii řízení rizika v simulovaném prostředí, staň se placeným B2B partnerem a získávej skutečné výplaty do 7 dnů, 80% podíl. Žádné sázky, žádné riziko vlastního kapitálu — jen tvoje disciplína.",
        ...
        compareSpeed: "Rychlost odměny", compareSpeedUs: "7 dnů", compareSpeedThem: "dny–týdny",
        ...
        mathNote: "Tenhle pevný split 80/20 plus jednorázový poplatek za hodnocení je celý byznys — je to stejný split od vašeho prvního dolaru až po desetitisící.",
        ...
        step3Name: "Hrajte", step3Desc: "Přihlaste se a během pár minut zadejte svůj první simulovaný tiket.",
    ...
    es: {
      ...
      why: {
        ...
        h4: "Soporte y recompensas rápidas", p4: "El soporte responde en horas y las recompensas de contratista aprobadas se pagan en 7 días.",
      ...
      discount: {
        title: "Obtén 30% de descuento", sub: "Ingresa tu correo y te enviaremos el código enseguida.", cta: "Enviarme el código", success: "Código enviado — revisa tu bandeja de entrada.", off: "DESCUENTO", consent: "Al solicitar el código aceptas recibir algunos correos con ofertas de Fundly. Puedes darte de baja en cualquier momento.",
      },
      preview: {
      ...
      footer: {
        ...
        privacy: "Privacidad", terms: "Términos", rules: "Reglas", disclaimer: "Aviso legal", refund: "Reembolso", aml: "Política AML", restrictedCountries: "Países restringidos",
      },
      auth: {
      ...
      gs: {
        ...
        previewCtaText: "Echa un vistazo gratis", previewCtaBtn: "Entrar →",
        accountSize: "Tamaño de cuenta",
        ...
        heroSub: "Fundly es una plataforma de evaluación para analistas deportivos — pon a prueba tu estrategia de gestión de riesgo en un entorno simulado, conviértete en socio B2B remunerado y recibe pagos reales en 7 días, 80% de reparto. Sin apuestas, sin riesgo de tu propio capital — solo tu disciplina.",
        ...
        compareSpeed: "Velocidad de recompensa", compareSpeedUs: "7 días", compareSpeedThem: "días–semanas",
        ...
        mathNote: "Ese reparto fijo 80/20 más la cuota única de evaluación es todo el negocio — es el mismo reparto desde tu primer dólar hasta el diez milésimo.",
        ...
        step3Name: "Juega", step3Desc: "Inicia sesión y envía tu primer ticket simulado en minutos.",
    ...
    pl: {
      ...
      why: {
        ...
        h4: "Szybkie wsparcie i nagrody", p4: "Wsparcie odpowiada w ciągu godzin, a zatwierdzone nagrody dla kontrahentów są wypłacane w ciągu 7 dni.",
      ...
      discount: {
        title: "Zdobądź 30% zniżki", sub: "Podaj swój e-mail, a od razu wyślemy Ci kod.", cta: "Wyślij mi kod", success: "Kod wysłany — sprawdź swoją skrzynkę.", off: "ZNIŻKI", consent: "Prosząc o kod, zgadzasz się na kilka e-maili z ofertami od Fundly. Możesz wypisać się w każdej chwili.",
      },
      preview: {
      ...
      footer: {
        ...
        privacy: "Prywatność", terms: "Warunki", rules: "Zasady", disclaimer: "Zastrzeżenie", refund: "Zwrot", aml: "Polityka AML", restrictedCountries: "Kraje objęte ograniczeniami",
      },
      auth: {
      ...
      gs: {
        ...
        previewCtaText: "Zajrzyj do środka za darmo", previewCtaBtn: "Wejdź →",
        accountSize: "Wielkość konta",
        ...
        heroSub: "Fundly to platforma oceniająca dla analityków sportowych — sprawdź swoją strategię zarządzania ryzykiem w symulowanym środowisku, zostań płatnym partnerem B2B i otrzymuj realne wypłaty w 7 dni, 80% udziału. Żadnych zakładów, żadnego ryzyka własnego kapitału — liczy się tylko Twoja dyscyplina.",
        ...
        compareSpeed: "Szybkość nagrody", compareSpeedUs: "7 dni", compareSpeedThem: "dni–tygodnie",
        ...
        mathNote: "Ten stały podział 80/20 plus jednorazowa opłata za ocenę to cały biznes — to ten sam podział od Twojego pierwszego dolara do dziesięciotysięcznego.",
        ...
        step3Name: "Graj", step3Desc: "Zaloguj się i złóż swoje pierwsze symulowane zlecenie w kilka minut.",
    ...
    sk: {
      ...
      why: {
        ...
        h4: "Rýchla podpora a odmeny", p4: "Podpora odpovedá do hodín a schválené odmeny pre dodávateľov sú vyplatené do 7 dní.",
      ...
      discount: {
        title: "Získaj 30% zľavu", sub: "Zadaj svoj e-mail a hneď ti pošleme kód.", cta: "Poslať mi kód", success: "Kód odoslaný — skontroluj si schránku.", off: "ZĽAVA", consent: "Vyžiadaním kódu súhlasíš s niekoľkými e-mailmi s ponukami od Fundly. Odhlásiť sa môžeš kedykoľvek.",
      },
      preview: {
      ...
      footer: {
        ...
        privacy: "Súkromie", terms: "Podmienky", rules: "Pravidlá", disclaimer: "Upozornenie", refund: "Vrátenie peňazí", aml: "AML politika", restrictedCountries: "Obmedzené krajiny",
      },
      auth: {
      ...
      gs: {
        ...
        previewCtaText: "Pozri sa dovnútra zadarmo", previewCtaBtn: "Vstúpiť →",
        accountSize: "Veľkosť účtu",
        ...
        heroSub: "Fundly je hodnotiaca platforma pre športových analytikov — over svoju stratégiu riadenia rizika v simulovanom prostredí, staň sa platiacim B2B partnerom a získavaj skutočné výplaty do 7 dní, 80% podiel. Žiadne stávky, žiadne riziko vlastného kapitálu — len tvoja disciplína.",
        ...
        compareSpeed: "Rýchlosť odmeny", compareSpeedUs: "7 dní", compareSpeedThem: "dni–týždne",
        ...
        youKeep: "Vy si necháte", weKeep: "My si necháme",
        mathNote: "Tento pevný split 80/20 plus jednorazový poplatok za hodnotenie je celý biznis — je to rovnaký split od vášho prvého dolára až po desaťtisíci.",
        ...
        step3Name: "Hrajte", step3Desc: "Prihláste sa a v priebehu pár minút zadajte svoj prvý simulovaný tiket.",
    ...
    hu: {
      ...
      why: {
        ...
        h4: "Gyors támogatás és jutalmak", p4: "A támogatás órákon belül válaszol, a jóváhagyott vállalkozói jutalmakat pedig 7 napon belül kifizetjük.",
      ...
      discount: {
        title: "Szerezz 30% kedvezményt", sub: "Add meg az e-mail címed, és azonnal elküldjük a kódot.", cta: "Küldd el a kódot", success: "Kód elküldve — nézd meg a postaládád.", off: "KEDVEZMÉNY", consent: "A kód kérésével hozzájárulsz néhány ajánlatokat tartalmazó e-mailhez a Fundlytól. Bármikor leiratkozhatsz.",
      },
      preview: {
      ...
      footer: {
        ...
        privacy: "Adatvédelem", terms: "Felhasználási feltételek", rules: "Szabályok", disclaimer: "Jogi nyilatkozat", refund: "Visszatérítés", aml: "AML szabályzat", restrictedCountries: "Korlátozott országok",
      },
      auth: {
      ...
      gs: {
        ...
        previewCtaText: "Nézz be ingyen", previewCtaBtn: "Belépés →",
        accountSize: "Számla mérete",
        ...
        heroSub: "A Fundly sportelemzők értékelő platformja — teszteld a kockázatkezelési stratégiádat szimulált környezetben, válj fizetett B2B partnerré, és kapj valódi kifizetéseket 7 napon belül, 80%-os részesedéssel. Nincs fogadás, nincs saját tőke kockázata — csak a fegyelmed számít.",
        ...
        compareSpeed: "Kifizetési sebesség", compareSpeedUs: "7 nap", compareSpeedThem: "napok–hetek",
        ...
        mathNote: "Ez a fix 80/20-as megosztás plusz az egyszeri értékelési díj az egész üzlet — ugyanaz az arány az első dollártól a tízezredikig.",
        ...
        step3Name: "Játssz", step3Desc: "Jelentkezz be, és percek alatt küldd el az első szimulált tippedet.",
