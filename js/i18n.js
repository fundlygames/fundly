  ...
  const DICT = {
    en: {
      ...
      gs: {
        ...
        heroSub: "Fundly is an evaluation platform for sports analysts — test your risk-management strategy in a simulated environment, become a paid B2B partner, and receive real payouts within 48 hours, 80% share. No wagers, no risk to your own capital — just your discipline.",
    ...
    cs: {
      ...
      gs: {
        ...
        heroSub: "Fundly je hodnoticí platforma pro sportovní analytiky — otestuj svou strategii řízení rizika v simulovaném prostředí, staň se placeným B2B partnerem a získávej skutečné výplaty do 48 hodin, 80% podíl. Žádné sázky, žádné riziko vlastního kapitálu — jen tvoje disciplína.",
    ...
    es: {
      ...
      gs: {
        ...
        heroSub: "Fundly es una plataforma de evaluación para analistas deportivos — pon a prueba tu estrategia de gestión de riesgo en un entorno simulado, conviértete en socio B2B remunerado y recibe pagos reales en 48 horas, 80% de reparto. Sin apuestas, sin riesgo de tu propio capital — solo tu disciplina.",
    ...
    pl: {
      ...
      gs: {
        ...
        heroSub: "Fundly to platforma oceniająca dla analityków sportowych — sprawdź swoją strategię zarządzania ryzykiem w symulowanym środowisku, zostań płatnym partnerem B2B i otrzymuj realne wypłaty w 48 godzin, 80% udziału. Żadnych zakładów, żadnego ryzyka własnego kapitału — liczy się tylko Twoja dyscyplina.",
    ...
    sk: {
      ...
      gs: {
        ...
        heroSub: "Fundly je hodnotiaca platforma pre športových analytikov — over svoju stratégiu riadenia rizika v simulovanom prostredí, staň sa platiacim B2B partnerom a získavaj skutočné výplaty do 48 hodín, 80% podiel. Žiadne stávky, žiadne riziko vlastného kapitálu — len tvoja disciplína.",
    ...
    hu: {
      ...
      gs: {
        ...
        heroSub: "A Fundly sportelemzők értékelő platformja — teszteld a kockázatkezelési stratégiádat szimulált környezetben, válj fizetett B2B partnerré, és kapj valódi kifizetéseket 48 órán belül, 80%-os részesedéssel. Nincs fogadás, nincs saját tőke kockázata — csak a fegyelmed számít.",
